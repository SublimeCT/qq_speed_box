...
class RecordsModel with ChangeNotifier {
  ...
  List<Record> getRecordsWhere({RecordCategory recordCategory , Series series, String author}) {
    return _records.where((Record r) {
      ...
      bool authorRight = author == null || r.author == author;
      return categoryRight && seriesRight && authorRight;
    }).toList();
  }
}